...
def get_pg_connection_str():
    user = get_config_prop("PGVECTOR_CONNECTION_USER", "langchain")
    password = get_config_prop("PGVECTOR_CONNECTION_PASSWORD", "langchain")
    host = get_config_prop("PGVECTOR_CONNECTION_HOST", "localhost")
    port = get_config_prop("PGVECTOR_CONNECTION_PORT", "6024")
    dbname = get_config_prop("PGVECTOR_CONNECTION_DBNAME", "langchain")
